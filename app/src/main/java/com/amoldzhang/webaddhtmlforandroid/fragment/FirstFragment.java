 ...
 */
public class FirstFragment extends BaseFragment implements SeekBar.OnSeekBarChangeListener,
    ...
    private int color = R.color.main_header_bg;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        //对整个菜单进行显示
        menu.setGroupVisible(R.menu.pie, true);
    }
    ...
    private void setStatusBar() {
        ...
        statusView.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape));
        //设置全屏的沉侵式状态栏
